...
console.log('ddd',leapYear)
//... leapYear[0][11]
for(let i=0; i<12; i++){
    if(i == 2){
        leapYear[0][i] = new Array(28) //윤년아닌 2월
        console.log('eee',leapYear)
    } else if(i%2!=0){
...
console.log('a', leapYear[0])
console.log(('b',leapYear[0][4]).length) //30개의 공백

leapYear[0][4][0] = 1
console.log('c',leapYear[0][4][0]) //오!!! 여기에 이제 작성하면 된다!!!!!! 요일을 작성해야하나
